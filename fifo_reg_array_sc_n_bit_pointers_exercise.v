...
assign raw_almost_full  = (depth[ADDR_WIDTH-1]==1'b1);//1xxx 8-15
assign raw_almost_empty = ((depth[ADDR_WIDTH-1]==1'b0)&&(depth[ADDR_WIDTH-4]==1'b1));//0xx1 1-7
...
//task #2: fill in the conditions for signal "empty" and "full".
	if ((depth ==4'b0) & (AE_AF_flag ==1'b0))
		empty =1'b1;
	if ((depth ==4'b0) & (AE_AF_flag == 1'b1)) 
		full = 1'b1      ;
end
